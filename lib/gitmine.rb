...
class Gitmine
  ...
  def self.branch(branch_name)
    ...
    if Config.github
      ...
      note << %{ - "See on Bitbucket":https://bitbucket.org/#{Config.bitbucket}/tree/#{branch_name}}
      note << %{ - "Compare on Bitbucket":https://bitbucket.org/#{Config.bitbucket}/compare/#{original_branch}...#{branch_name}#diff}
    end
